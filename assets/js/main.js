(function() {
  ...
  /**
   * Animate circular progress rings in skills section
   */
  const skillRings = document.querySelectorAll('.progress-circle');
  if (skillRings.length > 0) {
    skillRings.forEach(circle => {
  ...
  document.querySelectorAll('.isotope-layout').forEach(function(isotopeItem) {
    ...
    imagesLoaded(isotopeItem.querySelector('.isotope-container'), function() {
      ...
      // Update filter active class on buttons
    isotopeItem.querySelectorAll('.isotope-filters .nav-link').forEach(function(filterBtn) {
